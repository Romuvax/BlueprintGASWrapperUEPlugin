...
#define LOCTEXT_NAMESPACE "BlueprintGASWrapper"
...
{
	UE_LOG(LogBlueprintGASWrapper, Log, TEXT("Attribute Wizard FinishClicked"));
	...
	{
		UE_LOG(LogBlueprintGASWrapper, Error, TEXT("Error adding code to project: %s"), *OutFailReason.ToString())
	}
}
...
{
	UE_LOG(LogBlueprintGASWrapper, Log, TEXT("AddCodeToProject()"))
	...
	{
		UE_LOG(LogBlueprintGASWrapper, Error, TEXT("PrepareTemplate failed: %s"), *TemplateFailReason.ToString())
	...
	{
		UE_LOG(LogBlueprintGASWrapper, Error, TEXT("ResetTemplate failed: %s"), *TemplateFailReason.ToString())
	...
	{
		UE_LOG(LogBlueprintGASWrapper, Log, TEXT("AddCodeToProject() Succeeded"))
	...
	{
		UE_LOG(LogBlueprintGASWrapper, Log, TEXT("AddCodeToProject() FailedToHotReload %s"), *OutFailReason.ToString())
		OnAddedToProject.ExecuteIfBound(NewClassName, NewClassPath, SelectedModuleInfo->ModuleName);
	...
	{
		UE_LOG(LogBlueprintGASWrapper, Error, TEXT("AddAttributeCodeToProject() FailedToAddCode %s"), *OutFailReason.ToString())
