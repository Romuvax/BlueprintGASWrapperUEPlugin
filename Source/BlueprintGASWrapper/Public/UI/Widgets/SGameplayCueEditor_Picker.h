...
{
public:
	SLATE_BEGIN_ARGS( SPGameplayCuePickerDialog )
	{}
...
void SPGameplayCuePickerDialog::Construct(const FArguments& InArgs)
{
	...
	FString PathStr = SPGameplayCueEditor::GetPathNameForGameplayCueTag(GameplayCueTag);
			...
			[
				...
				[
					...
					[
						...
						.AreaTitle(NSLOCTEXT("SPGameplayCuePickerDialog", "CommonClassesAreaTitle", "GameplayCue Notifies"))
						.BodyContent()
						[
							SNew(SVerticalBox)
							+SVerticalBox::Slot()
							...
							[
								...
								.OnGenerateRow(this, &SPGameplayCuePickerDialog::GenerateListRow)
							]
				...
				[
					...
					[
						SNew(SExpandableArea)
						.AreaTitle(NSLOCTEXT("SPGameplayCuePickerDialogEvents", "CommonClassesAreaTitleEvents", "Custom BP Events"))
						.BodyContent()
						[
							SNew(SVerticalBox)
							+SVerticalBox::Slot()
...
bool SPGameplayCuePickerDialog::PickGameplayCue(const FText& TitleText, const TArray<UClass*>& DefaultClasses, UClass*& OutChosenClass, FString InGameplayCueName)
{
	...
	TSharedRef<SPGameplayCuePickerDialog> ClassPickerDialog = SNew(SPGameplayCuePickerDialog)
...
void SPGameplayCuePickerDialog::OnClassPicked(UClass* InChosenClass)
{
	ChosenClass = InChosenClass;
}

/** Generates rows in the list of GameplayCueNotify classes to pick from */
TSharedRef<ITableRow> SPGameplayCuePickerDialog::GenerateListRow(UClass* ItemClass, const TSharedRef<STableViewBase>& OwnerTable)
{	
	...
	[
		...
		[
			...
			[
				SNew(SButton)
				.OnClicked(this, &SPGameplayCuePickerDialog::OnDefaultClassPicked, ItemClass)
				.Content()
				[
					SNew(SHorizontalBox)
					+SHorizontalBox::Slot()
...
FReply SPGameplayCuePickerDialog::OnDefaultClassPicked(UClass* InChosenClass)
{
	ChosenClass = InChosenClass;
	bPressedOk = true;
...
FReply SPGameplayCuePickerDialog::OnClassPickerConfirmed()
{
	if (ChosenClass == NULL)
	{
